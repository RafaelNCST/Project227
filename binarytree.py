...
ImprimeArvoreBinaria = ''

def preOrdem(no):
	global ImprimeArvoreBinaria
	if no is None:
		return
	ImprimeArvoreBinaria += str(no.chave) + ', '
...
buscaRecursiva(arvore, 6)
buscaRecursiva(arvore, 9)
buscaRecursiva(arvore, 10) # Busca que imprime na propria funcao


print ('Altura :{}' .format(altura(arvore))) # Retorna a altura da arvore (int)
...
print ('Altura : {}' .format(altura(arvore)))